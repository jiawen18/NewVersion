<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Contact.aspx.cs" Inherits="NewVersion.css.Contact" %>
            ...
            <div class="block">
                <div class="row justify-content-center">
                    <div class="col-md-8 col-lg-8 pb-4">
                            ...
                            <div class="col-lg-4">
                                <div class="service no-shadow align-items-center link horizontal d-flex active" data-aos="fade-left" data-aos-delay="0">
                                    ...
                                    <div class="service-contents">
                                        <p>123 Tech Avenue, George Town, Penang, Malaysia</p>
                                    </div>
                                    <!-- /.service-contents-->
                                </div>
                                <!-- /.service -->
                        ...
                        <asp:Label ID="FeedbackLabel" runat="server" CssClass="mt-3" />
